...
public class HubShiftUtil {
  ...
  private static final double approachingActiveFudge = -1 * (1.0 + minFuelCountDelay);
  private static final double endingActiveFudge = shiftEndFuelCountExtension + - 1 * (1.6 + maxFuelCountDelay);
